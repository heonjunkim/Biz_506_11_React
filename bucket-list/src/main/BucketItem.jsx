...
class BucketItem extends Component {
  ...
  render() {
    ...
    /**
     * 이벤트 핸들러 등록 주의!!
     * 이벤트 핸들러를 등록할때 아래와 같이 등록 해버리면
     * 이 코드는 이벤트 핸들러를 등록하는 것이 아니라 즉시 실행코드가 되어 버린다
     * 즉, 데이터가 rendering이 될때 데이터의 개수만큼 반복적으로
     * 함수가 즉시 호출되어 React 문제가 발생한다
     *
     * 이벤트 핸들러에게 어떤 값을 전달하고 싶을떄는 callback 방식으로 전달해야 한다
      ...
      <tr>
        ...
        <td>
          <input
            ...
            onChange={(e) => {
              this.props.handelCancel(bucket.b_id);
            }}
          />
        </td>
      </tr>
