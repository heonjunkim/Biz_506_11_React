...
/*
id, name, number의 요소를 갖는 JSON 객체를 3개 포함하는
배열을 선언과 생성
phoneBook배열을 생성
*/
const PhoneMain = () => {
  ...
  // 일을 수행한다
  // useState(값) : state형 변수를 선언하고 초기화 시키는 일을 수행
  const [phoneBook, setPhoneBook] = useState([
    { id: 1, name: "피츄", number: "111" },
    { id: 2, name: "피카츄", number: "222" },
    { id: 3, name: "라이츄", number: "333" },
  ]);
  // onClickSave라는 함수를 Main에서 선언
  ...
  변수.current 속성은 state 변수와 달리 아무곳에서나 변수를 
  수정할 수 있다
